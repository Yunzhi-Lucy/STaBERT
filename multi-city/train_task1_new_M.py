...
from dataset_new_M import *
from model_new_M import *
...
#    device = torch.device("cpu")
    ...
    for epoch_id in range(args.epochs):
        for batch_id, batch in enumerate(tqdm(task1_dataloader_train)):
            ...
            output = model(batch['d'], batch['t'], batch['input_x'], batch['input_y'], batch['time_delta'], batch['len'], batch['poi_categories'], batch['poi_counts'], batch['city'])
