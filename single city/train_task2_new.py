...
#    name = f'batchsize{args.batch_size}_epochs{args.epochs}_embedsize{args.embed_size}_layersnum{args.layers_num}_headsnum{args.heads_num}_lr{args.lr}_seed{args.seed}'
    ...
    task2_dataset_train = HuMobDatasetTask2Train(path=args.dataset, poi_path=args.poi_dataset)
    task2_dataloader_train = DataLoader(task2_dataset_train, batch_size=args.batch_size, shuffle=True, collate_fn=collate_fn, num_workers=0, pin_memory=False)
